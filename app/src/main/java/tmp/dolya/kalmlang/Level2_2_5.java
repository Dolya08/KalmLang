...
public class Level2_2_5 extends AppCompatActivity {
    Dialog dialog;
    int numPic;
    ImageView imgMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level2_2_5.this, GameLevels.class);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (v.getId() == obj1.getId() && arrayLvl2_1.answer2[numPic] == 1) {
                        try {
                            Intent intent = new Intent(Level2_2_5.this, Level2_2_6.class);
                            startActivity(intent);
                            finish();
                        } catch (Exception ignored) {
