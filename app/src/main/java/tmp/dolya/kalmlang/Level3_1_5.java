...
public class Level3_1_5 extends AppCompatActivity {
    int numPic;
    ImageView imgMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level3_1_5.this, GameLevels.class);
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            if (event.getAction() == DragEvent.ACTION_DROP) {
                ...
                if (v.getId() == obj1.getId() && arrayLvl3.answer3_1[numPic] == 1) {
                    try {
                        Intent intent = new Intent(Level3_1_5.this, Level3_1_6.class);
                        startActivity(intent);
                        finish();
                    } catch (Exception ignored) {
